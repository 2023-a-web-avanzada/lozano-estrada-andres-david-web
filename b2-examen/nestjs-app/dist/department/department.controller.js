...
const department_create_dto_1 = require("./dto/department.create.dto");
let DepartmentController = exports.DepartmentController = class DepartmentController {
    ...
    getAllDepartments() {
        const options = {};
        return this.departmentService.findDepartments(options);
    }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [department_create_dto_1.DepartmentCreateDto]),
    __metadata("design:returntype", Promise)
